...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <p class="mb-4">Select treatment form for {{$name}}</p>

        <a class="nav-link ml-0" href="/patients/{{$id}}/show">
        ...
        <div class="row offset-sm-3">
            ...
            <!-- Premedication -->
            <div class="row-cols-xl-4 col-md-4 mb-3">
                <a href="/premedication/{{$id}}/update">
                    <div class="card forms h-100 py-2 bg-gradient-info">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
