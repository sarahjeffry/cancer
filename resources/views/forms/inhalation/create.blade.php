            ...
            <div class="card shadow offset-md-1 col-lg-10">
                ...
                <div class="form-inline justify-content-around">
                    <div class="mt-sm-3 justify-content-between">
                        ...
                        <div class="form-inline mb-sm-4">
                            <label class="control-label">Dose:</label> <input type="number" min="0.001" name="dose" class="form-control ml-2 mr-2" style="width: 90px;">
                            <select required class="form-control animated--fade-in mr-4" name="unit" id="unit" style="width: 80px;">
