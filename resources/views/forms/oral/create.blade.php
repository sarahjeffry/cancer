...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <a class="nav-link ml-0" href="/forms/oral">
                ...
                <div class="form-inline justify-content-around">
                    <div class="mt-sm-3 justify-content-between">
                        <div class="form-inline mb-sm-4">
                            ...
                            <label class="control-label">Drug name:</label> <input type="text" name="drugname" class="form-control ml-2 mr-4" style="width: 250px;" required>
                        </div>
                        <div class="form-inline mb-sm-4">
                            <label class="control-label">Dose:</label> <input type="text" name="dose" class="form-control ml-2 mr-2" style="width: 90px;" required>
                            ...
                            <label class="control-label ml-3">Frequency:</label>
