...
{{--            </div>--}}
        ...
        <a class="nav-link ml-0" href="/forms/statdoses">
            <i class="fas fa-fw mb-2 fa-arrow-circle-left"></i>
            <span>Change patient</span>
        </a>

        <form action="/statdoses/{{$patient->id}}/store" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            @method('GET')
            ...
            <div class="card shadow offset-md-1 col-lg-9">
                ...
                <div class="card-body ">&nbsp;&nbsp;
                    <div class="ml-lg-5 justify-content-between">
                        <div class="form-inline mb-sm-4 ml-5 ">
                            <label class="control-label mb-1">Date prescribed: </label> <input type="date" name="date" class="form-control ml-3 mr-4" style="width: 200px;" required>
                        ...
                        <div class="form-inline ml-5 mb-sm-4">
